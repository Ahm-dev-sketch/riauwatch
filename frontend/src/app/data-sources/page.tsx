      ...
      <main id="main-content" className="flex-1">
        ...
        <section className="bg-white border-b border-rw-gray-200">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            ...
            <p className="text-rw-gray-600 leading-relaxed max-w-2xl">
        ...
        <section className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-6">
          <div className="rounded-lg border border-rw-amber-100 bg-rw-amber-100/50 p-4">
            <h2 className="text-sm font-bold text-rw-gray-900 mb-2 flex items-center gap-2">
              <svg className="h-4 w-4 text-rw-amber-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
              </svg>
              Pernyataan Penting
            </h2>
            <div className="text-sm text-rw-gray-800 leading-relaxed space-y-2">
              <p>
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li>
                  <a
                    ...
                    className="text-rw-green-700 underline underline-offset-2 hover:text-rw-green-600 font-medium"
                  >
                    BMKG
                  </a>{" "}
        ...
        <section className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 pb-4">
          <div className="rounded-lg border border-rw-gray-200 bg-white p-4">
            <h2 className="text-sm font-bold text-rw-gray-900 mb-2 flex items-center gap-2">
            ...
            <div className="text-sm text-rw-gray-700 leading-relaxed space-y-2">
              <p>
              ...
              <p className="font-mono text-xs bg-rw-gray-50 rounded px-3 py-2 border border-rw-gray-100">
        ...
        <section className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 pb-8">
          <h2 className="text-lg font-semibold text-rw-gray-900 mb-4">
            Sumber Data Aktif
          </h2>
          ...
          {loading ? (
            <div className="space-y-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="animate-pulse rounded-xl border border-rw-gray-200 bg-white p-5">
                  <div className="h-4 bg-rw-gray-100 rounded w-1/3 mb-3" />
                  <div className="h-3 bg-rw-gray-100 rounded w-2/3 mb-2" />
            ...
            <div className="space-y-4">
              {data.sources.map((source) => (
                <article
                  key={source.key}
                  className="rounded-xl border border-rw-gray-200 bg-white p-5 hover:shadow-md transition-shadow"
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <h3 className="text-base font-semibold text-rw-gray-900">
                          {source.name}
                        </h3>
                        <span
                          className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium ${
                            source.active
                              ? "bg-rw-green-100 text-rw-green-700"
                              : "bg-rw-gray-100 text-rw-gray-600"
                          }`}
                        >
                      ...
                      <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                        <div>
                          <span className="text-rw-gray-500 block text-xs font-medium mb-0.5">
                            Penyedia
                          </span>
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-rw-green-700 underline underline-offset-2 hover:text-rw-green-600 break-all"
                          >
                            {source.provider_url}
                          </a>
                        </div>
                        <div>
                          ...
                          <span className="text-rw-gray-800">
                      ...
                      <div className="mt-3">
                        ...
                        <p className="text-sm text-rw-gray-700">{source.license_note}</p>
                      </div>
                      ...
                      <div className="mt-2">
                        ...
                        <p className="text-sm text-rw-gray-700 font-mono">{source.attribution}</p>
                      </div>
                    </div>
                  </div>
                </article>
            ...
            <div className="rounded-xl border border-rw-gray-200 bg-white p-8 text-center">
              <p className="text-rw-gray-500">
        ...
        <section className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 pb-8">
          <div className="rounded-xl border border-rw-gray-200 bg-rw-gray-50 p-5">
            <h2 className="text-sm font-bold text-rw-gray-900 mb-3">
              Metodologi & Keterbatasan
            </h2>
            <div className="text-sm text-rw-gray-700 leading-relaxed space-y-3">
              <p>
